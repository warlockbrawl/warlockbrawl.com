$(function() {
	if (!isMobile.any) {
		$('.jumbotron-video-container[data-jumbotron-video]').each(function() {
			...
			var $vid = $('<video class="jumbotron-video" loop muted autoplay poster="' + path + '.jpg"><source src="' + path + '.webm" type="video/webm"></source><source src="' + path + '.mp4" type="video/mp4"></source></video>');
